...
export default function Blog() {
  return (
    <div className=" h-auto relative  bottom-[-10s0px]   flex flex-col items-center  " >
      ...
      <div className=" relative w-90vw max-w-[] flex text-[clamp(35px,3.5vw,5rem)]  justify-center   items-center pt-10 pl-[0vw]"><span className="text-gray-900  font-bold ">Latest </span><span className="text-blue-900  font-bold ml-3">Updates</span><span className="text-gray-900 text-5xl font-extrabold "> </span></div>
      <section className=" flex justify-center items-center py-10 px-5  ">
        <div className="flex flex-wrap gap-8 justify-center">
          <div className="md:w-[420px]  w-[320px] md:h-[320px] h-[250px] bg-red-500 rounded-[14px]  shadow border  flex-col justify-center items-center inline-flex ">
            ...
            <div className="absolute md:w-[420px]  w-[320px] h-[150px] md:h-[150px] mt-[120px] md:mt-[170px] mr-1  z-3 text-wrap object-cover self-stretch  z-3 p-8 bg-white bg-opacity-75 rounded-md shadow-inner flex-col justify-center items-start gap-1.5 flex">
              <div className="self-stretch text-gray-900 text-xl md:text-2xl font-bold ">
