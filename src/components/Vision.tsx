...
export default function Vision() {
  return (
    <div>
      <section className=" flex w-full h-auto min-h-screen justify-center items-center bg-[#c6d0de] py-40 px-5  ">
        <div className="flex flex-wrap  gap-20  md:gap-40 lg:gap-8 justify-center ">
